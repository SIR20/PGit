...
//ToDo: Сделать папку и файл невидимыми. - сделал
...
//ToDo: Не работает если больше одного файла
...
begin
  ...
  if &File.Exists(f) and GetKey(name,f)
    then v := GetVersion(name, f).ToReal
    else ReVersion(name, v.ToString, f);
